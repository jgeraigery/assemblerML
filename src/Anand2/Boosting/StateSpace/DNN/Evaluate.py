...
def evaluate(result,name):
	...
	plt.figure(1)
	plt.subplot(3, 1, 1)
	plt.plot(result[0,80000:81000], result[1,80000:81000],c="k",linewidth="4",label="Pred")
	plt.plot(result[0,80000:81000], result[2,80000:81000]-result[6,80000:81000],c="r",label="True")
	plt.ylabel("TD State 0")
	plt.subplot(3, 1, 2)
	plt.plot(result[0,80000:81000], result[3,80000:81000],c="k",linewidth="4",label="Pred")
	plt.plot(result[0,80000:81000], result[4,80000:81000]-result[7,80000:81000],c="r",label="True")
	plt.ylabel("TD State 1")	
	plt.legend(loc="upper right")
	plt.subplot(3, 1, 3)
	plt.plot(result[0,80000:81000], result[5,80000:81000],c="k",label="Input")
	plt.ylabel("Control Input")
	plt.xlabel("Time")
	plt.legend(loc="upper right")
	plt.show()
	...
	plt.plot(np.arange(-45000,45000),crosscorr,c="k",linewidth="4",label="AutoCorrelation-State0")
	...
	crosscorr=NormCrossCorr(residuals.flatten(),residuals.flatten(),mode="same")
	plt.plot(np.arange(-45000,45000),crosscorr,c="k",linewidth="4",label="AutoCorrelation-State1")
	plt.ylabel("Correlation Value")
	plt.xlabel("Lag")
	plt.xlim(-1,1)
	plt.legend()
	...
	plt.plot(np.arange(-45000,45000),crosscorr,c="k",linewidth="4",label="CrossCorrelation")
	plt.ylabel("Correlation Value")
	plt.xlabel("Lag")
	plt.xlim(-1,1)
	plt.legend()
