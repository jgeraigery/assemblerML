...
def evaluate(result,name):
	...
	plt.figure(1)
	plt.subplot(3, 1, 1)
	plt.plot(result[0,11000:14000], result[1,11000:14000],c="k",linewidth="4",label="Pred")
	plt.plot(result[0,11000:14000], result[2,11000:14000]-result[6,11000:14000],c="r",label="True")
	plt.ylabel("TD State 0")
	plt.subplot(3, 1, 2)
	plt.plot(result[0,11000:14000], result[3,11000:14000],c="k",linewidth="4",label="Pred")
	plt.plot(result[0,11000:14000], result[4,11000:14000]-result[7,11000:14000],c="r",label="True")
	plt.ylabel("TD State 1")	
	plt.legend(loc="upper right")
	plt.subplot(3, 1, 3)
	plt.plot(result[0,11000:14000], result[5,11000:14000],c="k",label="Input")
	plt.ylabel("Control Input")
	plt.xlabel("Time")
	plt.legend(loc="upper right")
	plt.show()
