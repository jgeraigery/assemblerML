...
model1 = DenseModel(time_step=time_step,output_time_step=output_time_step,input_size=input_size,output_size=output_size,depth=3)
model2 = DenseModel(time_step=time_step,output_time_step=output_time_step,input_size=input_size,output_size=output_size+1,depth=3)

model = CyclicModel(model1,model2,time_step=time_step,input_size=input_size,output_size=output_size)
...
X=np.asarray(X)
y=np.asarray(y)
model.fit(X,[y,X],epochs=100,batch_size=32)
