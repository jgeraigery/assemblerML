...
def CyclicEnsembleModel(model1,model2,lr=0.0001,time_step=1,input_size=3,output_size=2):
	...
	output_a = keras.layers.average([output_a_1, output_b_1])			#Concatenating to weigh Model1 and Model2
	output_b = keras.layers.average([output_a_2, output_b_2])			#Concatenating to weigh Model1 and Model2
