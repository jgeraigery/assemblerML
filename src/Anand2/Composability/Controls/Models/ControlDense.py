...
def ControlDenseModel(input_size=3,time_step=1,output_time_step=1,output_size=2,lr=0.001,width=10,depth=1):
	...
	output = Dense(output_time_step*output_size,activation="sigmoid",use_bias=False)(x)
