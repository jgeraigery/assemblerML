...
def SingleDenseModel(input_size=5,time_step=1,output_time_step=1,output_size=2,lr=0.001,width=100,depth=2):
	...
	output1 = Dense(output_size,activation="linear",use_bias=False)(x)
	output2 = Dense(1,activation="linear",use_bias=False)(x)

	output1=Lambda(lambda xin :K.reshape(xin,(-1,output_time_step,output_size)))(output1)
	output2=Lambda(lambda xin :K.reshape(xin,(-1,output_time_step,1)))(output2)
