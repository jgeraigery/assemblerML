...
from keras.layers import Convolution2D, Dense, Input, MaxPooling2D, Dropout, Flatten, ZeroPadding2D, Activation,LSTM,Bidirectional,Convolution1D,MaxPooling1D,Conv1D,SimpleRNN,Lambda,Reshape,Flatten
...
#inputnew=Reshape((time_step * input_size))(input)
	inputnew=Flatten()(input)
	output = Dense(output_time_step*output_size,activation="linear",use_bias=False)(inputnew)
