...
parser.add_option("--basenetwork", dest="base_network", help="Base network to use. Supports Physics, Linear, RNN, Dense", default='Linear')
...
#Setting Second_Network
if options.ensemble_network=="Linear" or options.boost_network=="Linear":
...
elif options.ensemble_network=="RNN" or options.boost_network=="RNN":
...
elif options.ensemble_network=="Dense" or options.boost_network=="Dense":
...
Name=Name+"-Base-"+(options.base_network.replace(".h5","")) #Removing H5 if previously saved Base_Network
