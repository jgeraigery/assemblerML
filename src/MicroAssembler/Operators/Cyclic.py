...
def CyclicModel(model1,model2,lr=0.0001,time_step=1,input_size=3,output_size=2):
	input = Input(batch_shape=(None,time_step,input_size))
	input1=crop(2,input_size-1,input_size)(input)
	input2=crop(2,0,input_size-1)(input)
	...
	output_a2=keras.layers.add([input2,output_a])
	input2=keras.layers.concatenate([output_a2,input1],-1)
